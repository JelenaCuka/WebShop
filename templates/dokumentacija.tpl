<div id="dokumentacija" class="grupiranjeVeciEkrani">
    <h2 class="grupiranjeVeciEkrani">Dokumentacija</h2>
    <div class="grupiranjeVeciEkrani">
                <div class="grupiranjeVeciEkrani">
                    <h2>ERA dijagram</h2>
			<figure class="PopraviPoravnanje"> 
                    <a  href="slike/era.png"><img class="eraNav" src="slike/era.png" width="200" height="200" alt="Era "/></a>
                    <figcaption class="eraNav">Era </figcaption>
                </figure>
    </div>
<div class="grupiranjeVeciEkrani">
                    <h2 class="PopraviPoravnanje">Navigacijski dijagram planirano</h2>
			<figure class="PopraviPoravnanje"> 
                    <a href="slike/navigacijskiPlan.jpg"><img  src="slike/navigacijskiPlan.jpg" width="200" height="200" alt="Nav " class="PopraviPoravnanje eraNav" /></a>
                    <figcaption class="PopraviPoravnanje eraNav">Navigacijski </figcaption>

                </figure>
                    
</div>
        <div class="grupiranjeVeciEkrani">
                    <h2 class="PopraviPoravnanje">Navigacijski dijagram realizacija</h2>
			<figure class="PopraviPoravnanje"> 
                    <a href="slike/navigacijski.jpg"><img  src="slike/navigacijski.jpg" width="200" height="200" alt="Nav " class="PopraviPoravnanje eraNav" /></a>
                    <figcaption class="PopraviPoravnanje eraNav">Navigacijski </figcaption>

                </figure>
</div>
    <h2>Opis projektnog zadatka SAŽETO</h2>
    <div>Ovo je online trgovina. Posjetioci mogu naručivati proizvode koji su prikazani po kategorijama, omogućeno je i njihovo pretraživanje. Proizvode mogu dodavati u naružbu a prilikom izrade narudžbe definiraju količinu. Osim realizacije narudžbe vide i oglasee na stranici i mogu slijediti njihove linkove. Mogu vidjeti koji su proizvodi na akciji. Ako se registriraju mogu se prijaviti i zatražiti postavljanje svojih oglasa.
    Također mogu prijavljivati neispravne oglase. Moderator odobrava narudžbe i pri čemu se izdaju računi koje može pregledati i odobrava zahtjeve za oglase gdje je zadužen. Moderator definira predmete za koje kategorije je zadužen i može im dodavati akcije interval od do za koji se odluči. Moderator kreira vrste oglasa za pozicije kojima je moderator. Može prihvatiti blokiranje oglasa. Administrator kreira pozicije i konfigurira sustav i ima pregled statistika.</div>
    <div>    
    <h2>Opis projektnog zadatka DETALJNIJE</h2>
    <div>
